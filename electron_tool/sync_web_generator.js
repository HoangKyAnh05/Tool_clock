...
// Generates standalone, mobile-optimized TikTok Flashcard PWA for GitHub Pages with 1-Digit Cloud Sync
const fs = require('fs');
...
<head>
  ...
  <meta name="description" content="Ứng dụng Flashcard TikTok học từ vựng IELTS, lướt lên xuống chuẩn TikTok, sao lưu Cloud mã 1 số, phát âm to rõ.">
...
${jsonData}
  ...
  <script>
    ...
    window.addEventListener('keydown', (e) => {
      if (document.getElementById('searchModal').classList.contains('active') || document.getElementById('cloudSyncModal').classList.contains('active')) return;
      const list = getFilteredList();
...
const CACHE_NAME = 'tiktok-flashcard-v6';
